...
class Filmes extends Component {
    ...
    constructor(){
        ...
        this.state = {
            url : 'https://5f7f7553d6aabe00166f054c.mockapi.io/api/filmes',
            filmes : [],
            id : '',
            nome : '',
            categoria : '',
    ...
    listar(){
        ...
        // usando o metodo preencherTabela com os meus dados
        .then(dados => {
    ...
    salvar(event){
        ...
        event.preventDefault();
            ...
            //if ternário ? testa a condição, se for valido   : se não
