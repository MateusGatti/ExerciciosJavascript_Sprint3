                ...
                <Card.Body>
                    <Form onSubmit={event => salvar(event)}>
                        <Form.Group controlId="formBasicNome">
                            ...
                            <Form.Control type="text" value={nome} onChange={event => setNome(event.target.value)} placeholder="Tecnologia, Inovação, Startup, ..." ></Form.Control>
                        </Form.Group>
                        <Form.Group>
                ...
                <tbody>
                    {
                        categorias.map((item, index) => {
                            return(
                                <tr key={index}>
                                    <td><img src={item.urlImagem} style={{ width : '160px'}} /></td>
                                    <td>{item.nome}</td>
                                    <td>
